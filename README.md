...
**Applied Data Science Co-op Student @ Collège La Cité**
...
[![Portfolio](https://img.shields.io/badge/Portfolio-B8863B?style=flat-square\&logo=githubpages\&logoColor=white)](https://abdn-fz.github.io/)
...
Each step added something different:

* 📈 **Economics** → quantitative thinking and understanding real-world systems
* 📰 **Media** → communication, research and information storytelling
* 💻 **Digital projects** → technology and project coordination
* 🎓 **Professional training** → explaining complex concepts to diverse audiences
...
`SQL` · `Relational Databases` · `Data Cleaning` · `Data Transformation` · `ETL`
...
```text
     ...
     ┌────┴────┐         │         ┌────┴────┐
     │         │         │         │         │
   Pandas    NumPy    Databases    EDA    Modeling
     │         │         │         │         │
     └────┬────┘         │         └────┬────┘
          │              │              │
          └──────────────┼──────────────┘
...
### 🇨🇦 [Canadian City Intelligence](https://github.com/abdn-fz/canadian-city-intelligence)

An applied data science project exploring how major Canadian cities have evolved across **population, employment, unemployment, crime, cost of living and housing**.

**Cities covered:**

Montréal · Ottawa-Gatineau · Toronto · Winnipeg · Regina · Saskatoon · Calgary · Edmonton · Vancouver

### 🔎 Questions explored

* How have major Canadian cities changed over time?
* How does population evolution differ between cities?
* How have unemployment and labour-force indicators evolved?
...
One thing I value in data science is the ability to connect **technical work with real-world questions**.

My previous experience taught me to:

* communicate clearly with different audiences
* simplify complex information
* research and synthesize information
* work independently and collaboratively
* understand business and user perspectives
* present findings in a way people can actually use

That perspective is now becoming part of how I approach data science.
...
🌐 **Portfolio:** [abdn-fz.github.io](https://abdn-fz.github.io/)
...
**Les données, racontées simplement.**
